...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$AuthStatesCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements AuthStates<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$AuthStatesCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements AuthStates<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$AuthStatesCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AuthStates<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements AuthStates<T> {
